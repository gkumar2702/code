...
DF_OMS_LIVE = SPARK.read.format('CSV').option("header", "true").option("inferSchema", "true").option("delimiter", ",").load('gs://aes-analytics-0001-curated/Outage_Restoration/Live_Data_Curation/OMS/OMS_Live_Data.csv').toPandas()
