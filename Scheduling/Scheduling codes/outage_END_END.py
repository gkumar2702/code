...
output_file='gs://aes-datahub-0002-curated/Outage_Restoration/Staging/IPL_Live_Master_Dataset.csv'
...
with DAG(
  ...
  darksky_weather_data_collation= DataProcPySparkOperator(task_id='DARKSKY_WEATHER_DATA_COLLATION',
                                  main='gs://us-east4-composer-0002-8d07c42c-bucket/data/Outage_restoration/IPL/Python_scripts/darkskyweather_data_collation.py', 
                                  arguments=None, 
                                  archives=None, 
                                  pyfiles=None, 
                                  files=None, 
  ...
  curated_dataset_creation= DataProcPySparkOperator(task_id='CURATED_DATASET_CREATION',
                                  main='gs://us-east4-composer-0002-8d07c42c-bucket/data/Outage_restoration/IPL/Python_scripts/curated_dataset_creation.py', 
                                  arguments=None, 
                                  archives=None, 
                                  pyfiles=None, 
                                  files=None, 
  ...
  export_to_gcs = bigquery_to_gcs.BigQueryToCloudStorageOperator(
			task_id='export_bq_table_as_csv',
			source_project_dataset_table=intermediate_table,
			destination_cloud_storage_uris=[output_file],
			export_format='CSV')
  Classification_code_run = BashOperator(
    task_id='Classification_model_run',
    bash_command = "gcloud beta dataproc jobs submit spark-r    /home/airflow/gcs/data/Outage_restoration/IPL/R_scripts/Outage_classification.R  --cluster=outage-r-cluster-0002 --region=us-east4",
    dag=dag
    )
  ...
  bash_command = "gcloud beta dataproc jobs submit spark-r    /home/airflow/gcs/data/Outage_restoration/IPL/R_scripts/Regression_Run.R  --cluster=outage-r-cluster-0002 --region=us-east4",
  dag=dag
  )
  ...
  write_csv_to_bq_live  = GoogleCloudStorageToBigQueryOperator(
    ...
    # Create pipeline
oms_live_dataset_collation >> darksky_weather_data_collation >> curated_dataset_creation >>export_to_gcs >> Classification_code_run >> write_csv_to_bq >> Regression_code_run >> write_csv_to_bq2 >> write_csv_to_bq_live