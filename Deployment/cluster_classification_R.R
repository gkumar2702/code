...
#Reading the model object and the current weather forecast
...
input_filename<-paste0("gs://aes-datahub-0001-raw/Weather/weather_source/USA/Indianapolis/",month,"/forecast_data/",date,"/weathersource_daily_",date2,".csv",sep="")
...
output_file<-paste0("gs://aes-analytics-0001-curated/Outage_Restoration/Live_Data_Curation/Storm_Profiles/storm_profiles_",date2,".csv",sep="")
