...
write.csv(m1,paste0("/root/weather_data_clusters_his.csv"),row.names=FALSE)
output_file<-paste0("gs://aes-analytics-0001-curated/Outage_Restoration/Live_Data_Curation/Historical_Storm_Profiles/storm_profiles_",date2,".csv",sep="")
system(paste0("gsutil cp /root/weather_data_clusters_his.csv"," ",output_file,sep=""))
