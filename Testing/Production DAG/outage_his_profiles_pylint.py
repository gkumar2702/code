...
with DAG(
    ...
    WEATHERSOURCE_IPL = DataProcPySparkOperator(
        ...
        main='/home/airflow/gcs/data/Outage_restoration/IPL/\
        								      Python_scripts/weathersource_script.py',
        arguments=None,
        archives=None,
        pyfiles=None,
        files=None,
    ...
    CLUSTER_CLASSIFICATION = BashOperator(
        ...
        bash_command="gcloud beta dataproc jobs submit spark-r    /home/airflow/gcs/data/\
		              Outage_restoration/IPL/R_scripts/cluster_classification_R_his.R  --cluster=dp\
